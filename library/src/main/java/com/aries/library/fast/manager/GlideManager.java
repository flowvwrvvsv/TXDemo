...
public class GlideManager
{
    ...
    public static void loadImgFit(Object obj, ImageView iv, int placeholderResource) {
        Drawable drawable = getDrawable(iv.getContext(), placeholderResource);
        loadImgFit(obj, iv, drawable != null ? drawable : sCommonPlaceholderDrawable);
    }
    /**
     * 普通加载图片
     *
     ...
     * @param placeholder
     */
    public static void loadImgFit(Object obj, ImageView iv, Drawable placeholder) {
        Glide.with(iv.getContext()).load(obj).apply(getRequestOptions()
                .error(placeholder)
                .fitCenter()
                .placeholder(placeholder)
    ...
    public static void loadImgFit(Object obj, ImageView iv, int placeholderResource,SimpleTarget simpleTarget) {
        Drawable drawable = getDrawable(iv.getContext(), placeholderResource);
        loadImgFit(obj, iv, drawable != null ? drawable : sCommonPlaceholderDrawable,simpleTarget);
    }

    public static void loadImgFit(Object obj, ImageView iv, Drawable placeholder, SimpleTarget simpleTarget) {
        Glide.with(iv.getContext()).load(obj).apply(getRequestOptions()
                .error(placeholder)
                .fitCenter()
                .placeholder(placeholder)
                .fallback(placeholder)
                .dontAnimate()).into(simpleTarget);
