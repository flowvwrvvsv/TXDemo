...
public class CirclePercentBar extends View
{
    ...
    public CirclePercentBar(Context context, AttributeSet attrs, int defStyleAttr)
    {
        ...
        arcStartColor = typedArray.getColor(R.styleable.CirclePercentBar_arcStartColor,
                ActivityCompat.getColor(mContext, R.color.colorStart));
        arcEndColor = typedArray.getColor(R.styleable.CirclePercentBar_arcEndColor,
                ActivityCompat.getColor(mContext, R.color.colorEnd));
    ...
    private void initPaint()
    {
        ...
        arcCirclePaint.setColor(ActivityCompat.getColor(mContext, R.color.colorCirclebg));
    ...
    public void setPercentData(float data, final String suffix, TimeInterpolator interpolator)
    {
        if (data < 50)
        {
            mArcColor = ActivityCompat.getColor(getContext(), R.color.color_face_result_red);
            arcStartColor =  ActivityCompat.getColor(getContext(), R.color.color_face_result_red);
            arcEndColor =  ActivityCompat.getColor(getContext(), R.color.color_face_result_red);
        }
